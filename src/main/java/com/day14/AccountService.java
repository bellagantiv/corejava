...
public class AccountService {
    ...
    public void createAccount(String name, float balance){
        ...
        accList.add(account);
        System.out.println("Account create with number:" + account.getAccNumber());
    }

    public void withdareAmount(int accNumber, float amount){
    ...
    public void showAllAccountDetails(){
        if(accList.isEmpty()){
            System.out.println("Not yet accout are created, please creat accout to see details");
        }else{
